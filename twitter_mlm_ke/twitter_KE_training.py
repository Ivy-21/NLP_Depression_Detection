...
from twitter_KE_dataset import BertDataset
from twitter_KE_train import train
from twitter_KE_test import test
...
model.load_state_dict(torch.load('models/MLM/model_epoch_1'), strict = False)
...
model.load_state_dict(torch.load('models/twitter_KE/train_1/model_epoch_3_num186'))
print("Start Testing ...")
