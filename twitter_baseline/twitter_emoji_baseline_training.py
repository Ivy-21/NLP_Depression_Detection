...
from twitter_emoji_baseline_dataset import BertDataset
from twitter_emoji_baseline_train import train
from twitter_emoji_baseline_test import test
...
print("Loading emoji Tokenizer")
tokenizer = DistilBertTokenizer.from_pretrained('emoji_tokenizer', do_lower_case=False, tokenize_chinese_chars= False)
...
model.load_state_dict(torch.load('models/twitter_emoji_baseline/train_1/model_epoch_1_num222'))
print("Start Testing ...")
