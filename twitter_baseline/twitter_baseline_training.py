...
from twitter_baseline_train import train
from twitter_baseline_test import test
...
model.load_state_dict(torch.load('models/twitter_baseline/train_1/model_epoch_3_num57'))
print("Start Testing ...")
