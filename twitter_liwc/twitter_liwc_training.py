...
from twitter_liwc_dataset import BertDataset
from twitter_liwc_train import train
from twitter_liwc_test import test
...
model.load_state_dict(torch.load('models/twitter_liwc/train_1/model_epoch_3_num459'))
print("Start Testing ...")
